...
const home=[
  ...
  {
    image:"https://thumbs.dreamstime.com/b/motivational-speaker-headset-performing-stage-back-view-motivational-speaker-headset-performing-stage-back-view-253963797.jpg",
   ...
   Diversity is our strength, we would like to bring people from all walks of life to work together
    ...
    All plans include access to all features. Technology, Pricing, Customer Service, and Support will be provided.
        ...
        <Button variant="contained"  color="success" sx={{backgroundColor:"magenta"}}>
          ...
          <Typography variant="subtitle1"  textAlign="center" marginLeft="430px">
